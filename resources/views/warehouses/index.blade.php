            ...
            <table class="table table-sm table-hover border" id="mytable">
                ...
                <tbody>
                    @foreach($warehouses as $idx => $warehouse)
                        <tr>
                            <td><input type="checkbox" name="singlechecks" class="form-check-input singlechecks" value="{{$warehouse->id}}"></td>
                            <td>{{++$idx}}</td>
                            <td>{{$warehouse->name}}</td>
                            <td>{{$warehouse->status->name}}</td>
                            <td>{{$warehouse->user->name}}</td>
                            <td>{{$warehouse->created_at->format("d M Y")}} {{$warehouse->created_at->diffForHumans()}}</td>
                            ...
                            <td>
                                ...
                                <form action="{{route('warehouses.destroy',$warehouse->id)}}" method="post" id="formdelete-{{$idx}}">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
