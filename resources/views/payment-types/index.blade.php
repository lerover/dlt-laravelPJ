...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12">
            <form action="{{url('/paymentTypes')}}" method="POST">
                {{--@csrf--}}
                {{csrf_field()}}
            ...
            <table class="table table-sm table-hover border" id="mytable">
                ...
                @foreach($paymentTypes as $idx => $paymentType)
                    <tr>
                        ...
                        <td>{{$paymentType->created_at->format("d M Y")}} {{$paymentType->created_at->diffForHumans()}}</td>
                        ...
                        <td>
                            ...
                            <form action="{{route('paymentTypes.destroy',$paymentType->id)}}" method="post" id="formdelete-{{$idx}}">
                                @csrf
                                @method('DELETE')
                            </form>
                        </td>
